    ...
    private renderSelectOptionsCon: () => JSX.Element = () => {
        return (
            <div
                ...
                onClick={() => this.setFloatingConOpacity()}
            >
                <ul>
    ...
    render() {
        return (
            <div className={"sortBy-con"}>
                ...
                <div className={"sortBy-con-generic"}>Sort by</div>

                <div
                    className={"sortBy-con-selector"}
                    onClick={() => this.setFloatingConOpacity(true)}
                >
                    ...
                    <div className={"sortBy-con-selector-border"} />
                </div>
            </div>
        );
    }
